    ...
    >
      <div className="w-[90vw] max-w-[1200px] mx-auto flex flex-col gap-10 sm:gap-12">
        ...
        <div className="flex flex-col md:flex-row gap-8 md:gap-8 justify-between">
          ...
          {/* Wellbeing Resources */}
          <div className="solution-item flex flex-col">
            <FaHeart className="text-xl sm:text-2xl text-gray-800 mb-1 sm:mb-2" />
          ...
          {/* Audio Tools */}
          <div className="solution-item flex flex-col">
            <FaHeadphones className="text-xl sm:text-2xl text-gray-800 mb-1 sm:mb-2" />
