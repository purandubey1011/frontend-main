    ...
    <section className="w-full bg-[#E8FF47] py-20 px-4 md:px-12">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-14">
          <h2 className="text-3xl md:text-4xl font-semibold text-green-950">
            <span className="italic font-medium">Well Being</span> Resources
          </h2>
          <p className="text-gray-800 mt-3 max-w-2xl mx-auto text-base md:text-lg">
        ...
        <div className="flex flex-col md:flex-row gap-2 justify-center">
          {/* Card 1 */}
          <div className="bg-white rounded-2xl shadow-md w-full md:w-1/3 overflow-hidden">
            <img
